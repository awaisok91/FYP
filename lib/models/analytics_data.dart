class AnalyticsData {
  ...
  factory AnalyticsData.fromJson(Map<String, dynamic> json) {
    return AnalyticsData(
      ...
      recommendation: List<String>.from(json['recommendation'] ?? []),
      weeklyProgress: List<WeeklyProgress>.from(json["weeklyProgress"]
          ?.map((e) => WeeklyProgress(day: e['day'], minutes: e['minutes']))),
